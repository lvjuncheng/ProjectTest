...
CProjectTestDlg::CProjectTestDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CProjectTestDlg::IDD, pParent)
    , m_pcMyCamera(NULL)
    , m_nDeviceCombo(0)
    , m_bOpenDevice(FALSE)
...
int CProjectTestDlg::EnableControls(BOOL bIsCameraReady)
{
...
int CProjectTestDlg::DisplayWindowInitial(void)
{
...
void CProjectTestDlg::ShowErrorMsg(CString csMessage, int nErrorNum)
{
    CString errorMsg;
    if (nErrorNum == 0)
    {
...
int CProjectTestDlg::OpenDevice(void)
{
...
int CProjectTestDlg::CloseDevice(void)
{   
    if (m_pcMyCamera)
    {
        m_pcMyCamera->Close();
...
int CProjectTestDlg::GetTriggerMode(void)
{
    CString strFeature;
...
int CProjectTestDlg::SetTriggerMode(void)
{
...
int CProjectTestDlg::GetExposureTime(void)
{
...
int CProjectTestDlg::SetExposureTime(void)
{
...
// ch:获取增益 | en:Get Gain
int CProjectTestDlg::GetGain(void)
{
    float  fFloatValue = 0.0;
...
// ch:设置增益 | en:Set Gain
int CProjectTestDlg::SetGain(void)
{
...
int CProjectTestDlg::SetFrameRate(void)
{
...
int CProjectTestDlg::GetTriggerSource(void)
{
    unsigned int nEnumValue = 0;
...
int CProjectTestDlg::SetTriggerSource(void)
{
...
void CProjectTestDlg::OnBnClickedEnumButton()
{
    CString strMsg;
...
void CProjectTestDlg::OnBnClickedOpenButton()
{
    int nRet = OpenDevice();
    if (MV_OK != nRet)
    {
...
void CProjectTestDlg::OnBnClickedCloseButton()
{
    CloseDevice();
    EnableControls(TRUE);
...
void CProjectTestDlg::OnBnClickedStartGrabbingButton()
{
...
void CProjectTestDlg::OnBnClickedStopGrabbingButton()
{
...
void CProjectTestDlg::OnBnClickedGetParameterButton()
{
...
void CProjectTestDlg::OnBnClickedSoftwareTriggerCheck()
{
    UpdateData(TRUE);
...
void CProjectTestDlg::OnBnClickedSoftwareOnceButton()
{
...
void CProjectTestDlg::OnBnClickedSaveBmpButton()
{
...
BOOL CProjectTestDlg::PreTranslateMessage(MSG* pMsg)
{
